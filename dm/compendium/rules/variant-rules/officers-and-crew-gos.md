...
A poorly led or mistreated crew might turn against its officers. Once per day, if a crew's quality score is lower than 0, the captain must make a Charisma ([Intimidation](/compendium/rules/skills.md#Intimidation) or [Persuasion](/compendium/rules/skills.md#Persuasion)) check modified by the crew's quality score.
...
When the DM ends the mutiny, the crew's quality score increases by `dice: 1d4|avg` (`1d4`).
