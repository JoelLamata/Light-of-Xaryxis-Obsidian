...
***Death Throes.*** When the gauth dies, the magical energy within it explodes, and each creature within 10 feet of it must make a DC 14 Dexterity saving throw, taking `dice: 3d8|avg` (`3d8`) force damage on a failed save, or half as much damage on a successful one.
...
- **2 Enervation Ray.** The target must make a DC 14 Constitution saving throw, taking `dice: 4d8|avg` (`4d8`) necrotic damage on a failed save, or half as much damage on a successful one.  
