...
***Acid Breath (Recharge 5-6).*** The neothelid exhales acid in a 60-foot cone. Each creature in that area must make a DC 18 Dexterity saving throw, taking `dice: 10d6|avg` (`10d6`) acid damage on a failed save, or half as much damage on a successful one.
```
^statblock
