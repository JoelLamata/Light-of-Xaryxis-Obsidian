...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. *Hit:* `dice: 2d8 + 4|avg` (`2d8 + 4`) slashing damage, or `dice: 2d10 + 4|avg` (`2d10 + 4`) slashing damage if used with two hands, plus `dice: 2d8|avg` (`2d8`) fire damage.
