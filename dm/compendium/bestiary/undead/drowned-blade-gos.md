...
***Rusted Longsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. *Hit:* `dice: 1d8 + 3|avg` (`1d8 + 3`) slashing damage, and the target must succeed on a DC 12 Constitution saving throw or contract [bluerot](/compendium/rules/diseases.md#bluerot) (see the "Bluerot" in notes).
```
^statblock