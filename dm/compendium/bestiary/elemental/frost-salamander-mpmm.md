...
***Freezing Breath (Recharge 6).*** The salamander exhales chill wind in a 60-foot cone. Each creature in that area must make a DC 17 Constitution saving throw, taking `dice: 8d10|avg` (`8d10`) cold damage on a failed save, or half as much damage on a successful one.
```
^statblock
