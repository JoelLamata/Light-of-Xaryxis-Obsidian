...
***Spit Fire (Recharges after a Short or Long Rest).*** The firenewt spits fire at a creature within 10 feet of it. The creature must make a DC 11 Dexterity saving throw, taking `dice: 2d8|avg` (`2d8`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
