...
---
# Marid
*Source: Monster Manual p. 146, Ghosts of Saltmarsh, Tasha's Cauldron of Everything*  
...
***Trident.*** *Melee or Ranged Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice: 2d6 + 6|avg` (`2d6 + 6`) piercing damage, or `dice: 2d8 + 6|avg` (`2d8 + 6`) piercing damage if used with two hands to make a melee attack.
