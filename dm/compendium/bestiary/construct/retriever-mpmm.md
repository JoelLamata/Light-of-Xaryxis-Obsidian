...
***Force Beam.*** The retriever targets one creature it can see within 60 feet of it. The target must make a DC 16 Dexterity saving throw, taking `dice: 5d10|avg` (`5d10`) force damage on a failed save, or half as much damage on a successful one.
