...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. *Hit:* `dice: 1d8 + 3|avg` (`1d8 + 3`) force damage, or `dice: 1d10 + 3|avg` (`1d10 + 3`) force damage if used with two hands.
