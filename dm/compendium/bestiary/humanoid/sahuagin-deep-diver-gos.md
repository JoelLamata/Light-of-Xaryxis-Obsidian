...
***Brine Lurker.*** The deep diver has advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks made while submerged in water.
...
***Glaive.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 10 ft., one target. *Hit:* `dice: 2d10 + 2|avg` (`2d10 + 2`) slashing damage.

***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. *Hit:* `dice: 1d10 + 2|avg` (`1d10 + 2`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. *Hit:* `dice: 1d8 + 2|avg` (`1d8 + 2`) slashing damage.

***Light of Sekolah.*** The deep diver pulses magical light from its lure. Any creature within 30 feet of the deep diver that can see the light must succeed on a DC 11 Wisdom saving throw or be [charmed](/compendium/rules/conditions.md#charmed) until the end of its next turn. A creature [charmed](/compendium/rules/conditions.md#charmed) in this way is [incapacitated](/compendium/rules/conditions.md#incapacitated) as it stares at the light.
```
^statblock