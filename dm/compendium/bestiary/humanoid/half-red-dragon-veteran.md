...
*Source: Monster Manual p. 180, Ghosts of Saltmarsh. Available in the SRD.*  
...
***Fire Breath (Recharge 5-6).*** The veteran exhales fire in a 15-foot cone. Each creature in that area must make a DC 15 Dexterity saving throw, taking `dice: 7d6|avg` (`7d6`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock