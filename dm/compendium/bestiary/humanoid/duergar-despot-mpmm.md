...
***Psychic Engine.*** When the duergar suffers a critical hit or is reduced to 0 hit points, psychic energy erupts from its frame to deal `dice: 4d6|avg` (`4d6`) psychic damage to each creature within 5 feet of it.
...
***Stomping Foot.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. *Hit:* `dice: 1d10 + 5|avg` (`1d10 + 5`) bludgeoning damage, or `dice: 3d10 + 5|avg` (`3d10 + 5`) to a [prone](/compendium/rules/conditions.md#prone) target.

***Flame Jet.*** The duergar spews flames in a line 100 feet long and 5 feet wide. Each creature in the line must make a DC 16 Dexterity saving throw, taking `dice: 4d8|avg` (`4d8`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
