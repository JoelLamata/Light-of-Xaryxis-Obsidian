...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. *Hit:* `dice: 1d8 + 3|avg` (`1d8 + 3`) slashing damage, or `dice: 1d10 + 3|avg` (`1d10 + 3`) slashing damage if used with two hands, plus `dice: 5d8|avg` (`5d8`) psychic damage.
