...
```ad-statblock
title: Sahuagin High Priestess
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/GoS/Sahuagin%20High%20Priestess.webp#token)
...
***Spellcasting.*** The high priestess is a 7th-level spellcaster. Her spellcasting ability is Wisdom (spell save DC 14, `dice: d20+6` (+6 to hit) with spell attacks). She has the following cleric spells prepared:
...
**3rd level (3 slots)**: [bestow curse](compendium/spells/bestow-curse.md), [fear](compendium/spells/fear.md), [mass healing word](compendium/spells/mass-healing-word.md), [tongues](compendium/spells/tongues.md)
...
***Toothsome Staff.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. *Hit:* `dice: 2d8 + 2|avg` (`2d8 + 2`) piercing damage.

***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. *Hit:* `dice: 1d4 + 2|avg` (`1d4 + 2`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. *Hit:* `dice: 1d4 + 2|avg` (`1d4 + 2`) slashing damage.
```
^statblock