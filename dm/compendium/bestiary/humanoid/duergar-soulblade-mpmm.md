...
***Soulblade.*** *Melee Spell Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. *Hit:* `dice: 2d6 + 3|avg` (`2d6 + 3`) force damage, or `dice: 3d6 + 3|avg` (`3d6 + 3`) force damage while under the effect of Enlarge.
