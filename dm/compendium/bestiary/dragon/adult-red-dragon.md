...
---
# Adult Red Dragon
*Source: Monster Manual p. 98, Ghosts of Saltmarsh. Available in the SRD and the Basic Rules.*  
...
***Fire Breath (Recharge 5-6).*** The dragon exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking `dice: 18d6|avg` (`18d6`) fire damage on a failed save, or half as much damage on a successful one.
