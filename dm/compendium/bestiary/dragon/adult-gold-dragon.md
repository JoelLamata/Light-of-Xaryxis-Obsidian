...
---
# Adult Gold Dragon
*Source: Monster Manual p. 114, Ghosts of Saltmarsh. Available in the SRD.*  
...
- **Fire Breath.** The dragon exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking `dice: 12d10|avg` (`12d10`) fire damage on a failed save, or half as much damage on a successful one.  
