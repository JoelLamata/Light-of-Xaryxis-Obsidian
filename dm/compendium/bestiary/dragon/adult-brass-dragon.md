...
- **Fire Breath.** The dragon exhales fire in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 18 Dexterity saving throw, taking `dice: 13d6|avg` (`13d6`) fire damage on a failed save, or half as much damage on a successful one.  
