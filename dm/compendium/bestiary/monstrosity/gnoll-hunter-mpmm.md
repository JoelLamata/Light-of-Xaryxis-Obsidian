...
***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice: 1d6 + 2|avg` (`1d6 + 2`) piercing damage, or `dice: 1d8 + 2|avg` (`1d8 + 2`) piercing damage when used with two hands to make a melee attack.
