...
---
# Purple Worm
*Source: Monster Manual p. 255, Light of Xaryxis. Available in the SRD.*  
...
***Tail Stinger.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 10 ft., one creature. *Hit:* `dice: 3d6 + 9|avg` (`3d6 + 9`) piercing damage, and the target must make a DC 19 Constitution saving throw, taking `dice: 12d6|avg` (`12d6`) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
