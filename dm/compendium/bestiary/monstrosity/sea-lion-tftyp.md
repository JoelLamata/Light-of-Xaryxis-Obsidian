...
```ad-statblock
title: Sea Lion
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TftYP/Sea%20Lion.webp#token)
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. *Hit:* `dice: 2d8 + 3|avg` (`2d8 + 3`) piercing damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. *Hit:* `dice: 2d8 + 3|avg` (`2d8 + 3`) piercing damage.
```
^statblock