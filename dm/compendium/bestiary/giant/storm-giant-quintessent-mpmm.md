...
***Wind Javelin.*** The giant coalesces wind into a javelin-like form and hurls it at a creature it can see within 600 feet of it. The javelin deals `dice: 3d6 + 9|avg` (`3d6 + 9`) force damage to the target, striking unerringly. The javelin disappears after it hits.
...
***Thunderbolt (Costs 2 Actions).*** The giant hurls a thunderbolt at a creature it can see within 600 feet of it. The target must make a DC 18 Dexterity saving throw, taking `dice: 4d10|avg` (`4d10`) thunder damage on a failed save, or half as much damage on a successful one.
