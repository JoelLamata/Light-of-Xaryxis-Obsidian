...
```ad-statblock
title: Flapjack
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Flapjack.webp#token)
...
***Prone Deficiency.*** If Flapjack is knocked [prone](/compendium/rules/conditions.md#prone), roll a die. On an odd result, Flapjack lands upside-down and is [incapacitated](/compendium/rules/conditions.md#incapacitated). At the end of each of its turns, Flapjack can make a DC 10 Dexterity saving throw, righting itself and ending the [incapacitated](/compendium/rules/conditions.md#incapacitated) condition if it succeeds.
