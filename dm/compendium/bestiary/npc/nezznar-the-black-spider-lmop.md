...
***Spellcasting.*** Nezznar is a 4th-level spellcaster that uses Intelligence as his spellcasting ability (spell save DC 13; `dice: d20+5` (+5 to hit) with spell attacks). Nezznar has the following spells prepared from the wizard's spell list:
...
***Spider Staff.*** *Melee Weapon Attack:* `dice: d20+1` (+1 to hit), reach 5 ft., one target. *Hit:* `dice: 1d6 - 1|avg` (`1d6 - 1`) bludgeoning damage plus `dice: 1d6|avg` (`1d6`) poison damage.
```
^statblock