...
```ad-statblock
title: Hastain
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Hastain.webp#token)
*Medium celestial, typically  Chaotic Evil*
...
***Glory.*** Hastain's Armor Class includes its Charisma modifier.

***Hold Breath.*** Hastain can hold its breath for 1 hour.

***Special Equipment.*** Hastain wears a talarith.
