...
***Fear Aura.*** Any creature hostile to Bel that starts its turn within 20 feet of him must make a DC 23 Wisdom saving throw, unless Bel is [incapacitated](/compendium/rules/conditions.md#incapacitated). Unless the save succeeds, the creature is [frightened](/compendium/rules/conditions.md#frightened) until the start of its next turn. If a creature's saving throw is successful, the creature is immune to Bel's Fear Aura for the next 24 hours.
...
***Greatsword.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. *Hit:* `dice: 4d6 + 9|avg` (`4d6 + 9`) slashing damage plus `dice: 6d6|avg` (`6d6`) fire damage. If the target is a flammable object that is not being held or worn, it catches fire.

***Tail.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. *Hit:* `dice: 3d10 + 9|avg` (`3d10 + 9`) bludgeoning damage. If the target is a creature, it must succeed on a DC 23 Constitution saving throw or be [stunned](/compendium/rules/conditions.md#stunned) until the end of its next turn.

## Legendary Actions

***Fireball.*** Bel casts [fireball](compendium/spells/fireball.md).

***Tactical Edge (Costs 2 Actions).*** Roll a `dice: d6|avg` (`d6`) for Bel. The number rolled on the die is subtracted from the next attack roll made against Bel or an ally of his choice within the next minute.
