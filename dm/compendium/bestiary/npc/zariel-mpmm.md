...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. *Hit:* `dice: 2d8 + 8|avg` (`2d8 + 8`) radiant damage, or `dice: 2d10 + 8|avg` (`2d10 + 8`) radiant damage when used with two hands, plus `dice: 8d8|avg` (`8d8`) fire damage.
