...
```ad-statblock
title: Grimzod Gargenhale
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Grimzod%20Gargenhale.webp#token)
...
***Unusual Nature.*** Grimzod doesn't require air or drink.
...
***Uncanny Dodge.*** Grimzod halves the damage that it takes from an attack that hits it. Grimzod must be able to see the attacker.
```
^statblock