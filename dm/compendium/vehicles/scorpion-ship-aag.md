...
```ad-statblock
title: Scorpion Ship
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/vehicles/tokens/AAG/Scorpion%20Ship.webp#token)
...
**Claw** *Melee Weapon Attack:* +3 to hit, reach 20 ft., one target. *Hit:* `dice: 2d10|avg` (`2d10`) bludgeoning damage. If the target is a Huge or smaller creature, it is also [grappled](/compendium/rules/conditions.md#grappled) (escape DC 13). Until this grapple ends, the creature takes `dice: 2d10|avg` (`2d10`) bludgeoning damage at the start of each of its turns.
