...
- 1 [major detrimental property](compendium/tables/artifact-properties-major-detrimental-properties.md), which is suppressed while the sword is attuned to an archdevil  

## Ruler of Avernus

As an action, you can point this sword at one devil you can see within 60 feet of you. That devil must succeed on a DC 22 Charisma saving throw or be [charmed](/compendium/rules/conditions.md#charmed) by you for 1 hour. While [charmed](/compendium/rules/conditions.md#charmed) in this way, the devil follows your orders to the best of its ability. If you command the devil to do something it perceives as suicidal, the effect ends and you can no longer use this power of the sword against that devil.

## Infernal Recall

As an action, you can use the sword to cast [word of recall](compendium/spells/word-of-recall.md). Creatures transported by this spell appear in an unoccupied space within 30 feet of the current ruler of Avernus, or a sanctuary you designate if you rule Avernus.
