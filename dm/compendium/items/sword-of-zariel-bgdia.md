...
- **Truesight.** Your eyes become luminous pools of silver. You can see in normal and magical darkness, see [invisible](/compendium/rules/conditions.md#invisible) creatures and objects, automatically detect visual illusions and succeed on saving throws against them, perceive the original form of a shapechanger or a creature that is transformed by magic, and see into the Ethereal Plane, all within a range of 60 feet.  
...
The sword deals an extra `dice: 2d8|avg` (`2d8`) radiant damage to any creature it hits, or `dice: 3d10|avg` (`3d10`) radiant damage if you're wielding the weapon with two hands. An evil creature that takes this radiant damage must succeed on a DC 17 Constitution saving throw or be [blinded](/compendium/rules/conditions.md#blinded) until the end of its next turn.
...
While holding the sword, you gain advantage on all Wisdom ([Insight](/compendium/rules/skills.md#Insight)) checks.
