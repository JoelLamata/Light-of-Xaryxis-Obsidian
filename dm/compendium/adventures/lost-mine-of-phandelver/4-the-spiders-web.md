...
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/adventure/LMoP/The%20Sword%20Coast%20(Player).webp#gallery)
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1-2 | [Stirges](compendium/bestiary/beast/stirge.md) (`dice: 1d8 + 2\|avg` (`1d8 + 2`)) |
| 3-4 | [Ogre](compendium/bestiary/giant/ogre.md) (1) |
| 5-6 | [Goblins](compendium/bestiary/humanoid/goblin.md) (`dice: 1d6 + 3\|avg` (`1d6 + 3`)) |
| 7-8 | [Hobgoblins](compendium/bestiary/humanoid/hobgoblin.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
| 9-10 | [Orcs](compendium/bestiary/humanoid/orc.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
| 11 | [Wolves](compendium/bestiary/beast/wolf.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1-3 | [Stirges](compendium/bestiary/beast/stirge.md) (`dice: 1d8 + 2\|avg` (`1d8 + 2`)) |
| 4 | [Ghouls](compendium/bestiary/undead/ghoul.md) (`dice: 1d4 + 1\|avg` (`1d4 + 1`)) |
| 5 | [Goblins](compendium/bestiary/humanoid/goblin.md) (`dice: 1d6 + 3\|avg` (`1d6 + 3`)) |
| 6 | [Hobgoblins](compendium/bestiary/humanoid/hobgoblin.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
| 7-8 | [Orcs](compendium/bestiary/humanoid/orc.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
| 9-10 | [Wolves](compendium/bestiary/beast/wolf.md) (`dice: 1d4 + 2\|avg` (`1d4 + 2`)) |
...
Hamun Kost's tent contains a comfortable traveling suite, including a cot, a chair, a writing desk, supplies, and a chest of clothes. In the chest is a leather bag containing 35 sp, 20 ep, 20 gp, 5 pp, one pearl (100 gp), a [potion of healing](compendium/items/potion-of-healing.md), a [scroll of](compendium/items/spell-scroll-2nd-level.md) [darkness](compendium/spells/darkness.md) in a bone tube, and a tiny jeweled box (25 gp) containing a [ring of protection](compendium/items/ring-of-protection.md) from ancient Netheril, the Red Wizard's most interesting discovery so far.
...
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/adventure/LMoP/Ruins%20of%20Thundertree%20(Player).webp#gallery)
...
The webs fill two squares north of the doorway (and the square marked "6"). They are difficult terrain, and a creature trying to move through them must succeed on a DC 10 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check. On a failure, the creature is [restrained](/compendium/rules/conditions.md#restrained) in the [webs](compendium/traps-hazards/webs.md) (see the rulebook for the effects of being [restrained](/compendium/rules/conditions.md#restrained)). A snared creature can take an action each round to attempt to break free with a DC 12 Strength check, or it can try to cut its way free by using a light weapon that deals slashing damage. The webs have AC 10, 5 hit points, vulnerability to fire damage, and immunity to bludgeoning, poison, and psychic damage (see "Damage Resistance and Vulnerability" in the rulebook for how vulnerability works).
...
An old wooden chest broken open on the tower floor holds the last of the dead wizard's treasure: 800 sp, 150 gp, four silver goblets set with moonstones (60 gp each), a [scroll of](compendium/items/spell-scroll-2nd-level.md) [misty step](compendium/spells/misty-step.md), and a [scroll of](compendium/items/spell-scroll-3rd-level.md) [lightning bolt](compendium/spells/lightning-bolt.md). [Venomfang](compendium/bestiary/npc/venomfang-lmop.md) spends much of his time greedily admiring the loot.
...
In the main room, Favric has a small coffer containing tribute for the green dragon: three diamonds (100 gp each). He also carries a [potion of flying](compendium/items/potion-of-flying.md) in a stoppered vial around his neck.
...
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/adventure/LMoP/Cragmaw%20Castle%20(Player).webp#gallery)
...
All that remains of the tower's second floor is a jagged ledge, upon which sits a battered wooden chest. The chest is hard to see from the floor, requiring a successful DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check to notice. The chest is unlocked and contains 90 ep, 120 gp, a [potion of healing](compendium/items/potion-of-healing.md), a [scroll of](compendium/items/spell-scroll-2nd-level.md) [silence](compendium/spells/silence.md), and a [scroll of](compendium/items/spell-scroll-3rd-level.md) [revivify](compendium/spells/revivify.md).
...
Hidden under Grol's bed mattress is a stitched leather sack containing 220 sp, 160 ep, three [potions of healing](compendium/items/potion-of-healing.md), and Gundren's map to Wave Echo Cave.
